...
uint32_t PORT0_PDO_ListSRC[USBPD_MAX_NB_PDO] =
{
  /* PDO 1 */
        ( ((PWR_A_10MA(USBPD_CORE_PDO_SRC_FIXED_MAX_CURRENT / 1000.0)) << USBPD_PDO_SRC_FIXED_MAX_CURRENT_Pos) |
          ((PWR_V_50MV(USBPD_BOARD_REQUESTED_VOLTAGE_MV / 1000.0)) << USBPD_PDO_SRC_FIXED_VOLTAGE_Pos)                                        |
  ...
  /* PDO 2 */
        ( ((PWR_A_10MA(3000 / 1000.0)) << USBPD_PDO_SRC_FIXED_MAX_CURRENT_Pos) |
          ((PWR_V_50MV(20000 / 1000.0)) << USBPD_PDO_SRC_FIXED_VOLTAGE_Pos)                                        |
          USBPD_PDO_SRC_FIXED_PEAKCURRENT_EQUAL                                                       |
          USBPD_PDO_SRC_FIXED_UNCHUNK_NOT_SUPPORTED                                                   |
          USBPD_PDO_SRC_FIXED_DRD_NOT_SUPPORTED                                                           |
          USBPD_PDO_SRC_FIXED_USBCOMM_NOT_SUPPORTED                                                   |
...
uint32_t PORT0_PDO_ListSNK[USBPD_MAX_NB_PDO] =
{
  ...
  /* PDO 2 */
        ( ((PWR_A_10MA(1000 / 1000.0)) << USBPD_PDO_SNK_FIXED_OP_CURRENT_Pos) |
          ((PWR_V_50MV(9000 / 1000.0)) << USBPD_PDO_SNK_FIXED_VOLTAGE_Pos) |
           USBPD_PDO_TYPE_FIXED
        ),
  /* PDO 3 */
        ( ((PWR_A_10MA(1000 / 1000.0)) << USBPD_PDO_SNK_FIXED_OP_CURRENT_Pos) |
          ((PWR_V_50MV(12000 / 1000.0)) << USBPD_PDO_SNK_FIXED_VOLTAGE_Pos) |
           USBPD_PDO_TYPE_FIXED
        ),
  /* PDO 4 */
        ( ((PWR_A_10MA(1000 / 1000.0)) << USBPD_PDO_SNK_FIXED_OP_CURRENT_Pos) |
  ...
  /* PDO 5 */
        ( ((PWR_A_10MA(1000 / 1000.0)) << USBPD_PDO_SNK_FIXED_OP_CURRENT_Pos) |
          ((PWR_V_50MV(20000 / 1000.0)) << USBPD_PDO_SNK_FIXED_VOLTAGE_Pos) |
           USBPD_PDO_TYPE_FIXED
        ),
  /* PDO 6 */
        (0x00000000U),
